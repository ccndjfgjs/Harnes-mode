...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-about AboutSection id \'about\'',
      'client-ui-settings-accessibility AccessibilitySection id \'accessibility\'',
      'client-ui-settings-accounts AccountsSection id \'accounts\'',
      'client-ui-settings-customization CustomizationSection id \'customization\'',
      'client-ui-settings-general GeneralSection id \'general\'',
      'client-ui-settings-models ModelsSection id \'models\'',
      'client-ui-settings-plugins PluginsSettingsSection id \'plugins\'',
      'client-ui-settings-voice VoiceSection id \'voice\'',
    ],
    replaceRisk: 'none',
