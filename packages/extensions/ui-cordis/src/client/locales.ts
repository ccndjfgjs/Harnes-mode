...
export const ru = {
  ...
  'status.idle': 'Готов',
  'status.awaitingApproval': 'Ожидание подтверждения',
  'status.failed': 'Ошибка выполнения',
  'status.clientPending': 'Client готов к активации',
  'status.running': 'Выполняется',
  'status.removed': 'Удалён',
  'status.superseded': 'Доступен новый запуск',
  'run.removed': 'Пакета больше нет',
  'run.superseded': 'Ниже доступна новая карточка запуска',
  'panel.hint': 'Управление запусками — в панели Cordis над настройками',
  ...
  'panel.readFailed': 'Ошибка чтения списка плагинов: {message}',
  ...
  'action.approveOnce': 'Только эту версию',
  'action.approvePlugin': 'Разрешить будущие версии плагина',
  ...
  'render.failedAbdicated': 'Ошибка рендера в {slot}; восстановлен интерфейс по умолчанию:',
  'render.failedHeld': 'Ошибка рендера в {slot}:',
