...
export const ru: Record<TrajectoryKey, string> = {
  ...
  'toolbar.useActualDuration': 'Реальное время',
  ...
  'record.noPayload': 'Данные не записаны',
  ...
  'block.openSummary': 'Открыть сводку вызова #{index}',
  ...
  'history.clickToLoadEarlier': 'Нажмите чтобы загрузить раньше',
  ...
  'details.resize': 'Детали изменения размера',
  'details.resizeTitle': 'Тяните чтобы изменить размер. Двойной клик — сброс.',
  ...
  'timeline.overviewAria': 'Обзор шкалы; тяните горизонтально чтобы сфокусировать события',
  'timeline.noTimingData': 'Нет данных времени',
