...
export const ru: Record<PluginsSettingsLocaleKey, string> = {
  ...
  bashTimeoutMsHint: 'Сколько может выполняться одна команда до завершения.',
  ...
  agentLoopMaxParallelHint: 'Сколько безопасных вызовов может выполняться одновременно в одном шаге.',
  webSearchTitle: 'Веб-поиск',
  webSearchDescription: 'Поисковый провайдер DeepSeek.',
  webSearchApiKey: 'API-ключ',
  webSearchApiKeyHint: 'Не записывается в файл настроек. Оставьте пустым, чтобы сохранить текущий ключ.',
  ...
  webSearchBaseUrlHint: 'Оставьте пустым для адреса по умолчанию.',
  webSearchMaxUses: 'Поисков на запрос',
  webSearchMaxUsesHint: 'Сколько раз запрос может искать, прежде чем должен ответить.',
  subagentModelSelectionTitle: 'Суб-агент',
  subagentModelSelectionDescription: 'Какие модели агенты могут выбирать для суб-агентов.',
  subagentModelSelectionToggle: 'Разрешить агентам выбирать модели для суб-агентов',
  subagentModelSelectionChoose: 'Когда включено, агенты могут выбирать провайдера, модель и уровень рассуждений для каждого суб-агента из разрешённых ниже. Только для новых сессий.',
  subagentModelSelectionAllowed: 'Модели на выбор агентам',
  ...
  subagentModelSelectionPartial: 'Часть провайдеров моделей недоступна; сохранённый выбор можно удалить.',
  subagentModelSelectionUnavailable: 'Сейчас недоступно',
  subagentModelSelectionUnavailableGroup: 'Сохранено, но сейчас недоступно',
  subagentModelSelectionEmpty: 'Провайдеры пока не предлагают моделей.',
  subagentModelSelectionRequired: 'Перед сохранением выберите хотя бы одну модель.',
  subagentModelSelectionConflict: 'Настройки изменили в другом месте. Отмените черновик и попробуйте снова.',
  subagentModelSelectionOff: 'Суб-агенты используют настроенную модель по умолчанию или наследуют модель родительского агента. Выбранные модели сохраняются.',
}
