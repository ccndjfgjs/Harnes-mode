...
export const ru: { [Key in keyof typeof en]: string } = {
  nav: 'Модели',
  title: 'Модели',
  intro: 'Введите API-ключи, чтобы использовать модели этих провайдеров.',
  edit: 'Изменить',
  editProvider: 'Изменить {provider}',
  remove: 'Удалить',
  removeProvider: 'Удалить {provider}',
  deleteTitle: 'Удалить {provider}?',
  deleteDescription: 'Удаление {provider} уберёт его настройки. Используемые им ключи хранятся отдельно и сохранятся.',
  deleteDescriptionWithCredential: 'Удаление {provider} уберёт его настройки и сохранённый API-ключ.',
  ...
  credentialMissing: 'Нет API-ключа',
  readOnly: 'Файл настроек в этом развёртывании только для чтения.',
  loadFailed: 'Не удалось загрузить каталог провайдеров',
  conflict: 'Пока карточка была открыта, эти настройки изменили в другом месте. Закройте и откройте её для правки текущих значений.',
  retry: 'Повторить',
  keyInput: 'API-ключ',
  ...
  modelsEmpty: 'В выборе не будет моделей. ID вне каталога всё равно можно отправлять напрямую.',
  keyBlank: 'Введите API-ключ или оставьте пустым, чтобы сохранить хранящийся.',
  keyBlankNew: 'Введите API-ключ или оставьте пустым, если провайдер аутентифицируется иначе.',
  keyIllegalCharacters: 'Недопустимый формат API-ключа. Проверьте его.',
  modelIdRequired: 'Укажите ID модели.',
  modelIdDuplicate: 'ID модели должен быть уникальным.',
  modelNameInvalid: 'Отображаемое имя не должно быть пустым.',
  modelContextInvalid: 'Контекстное окно — положительное число, например 131072, 256K или 1M.',
  modelMaxTokensInvalid: 'Макс. токенов ответа — положительное число, например 8192, 64K или 1M.',
  advancedHint: 'Остальные поля — в settings.yaml, правьте раздел напрямую.',
  modelCapacityInvalid: 'Возможность — число, можно с суффиксом K или M.',
  modelDuplicate: 'Каждый ID модели встречается один раз.',
  modelContextWindow: 'Контекстное окно',
  modelMaxTokens: 'Макс. токенов ответа',
  fetchModels: 'Получить доступные модели',
  fetching: 'Запрос провайдеру…',
  fetchNeedsBaseUrl: 'Сначала введите базовый URL, затем получайте.',
  fetchEmpty: 'Провайдер не перечислил моделей. Добавьте вручную.',
  fetchTitle: 'Выберите модели для добавления',
  fetchDescription: 'Доступные модели этого провайдера. Отметьте нужные.',
  ...
  customRouteHint: 'Строчный идентификатор с буквы, уникально называет провайдера в запросах и в имени ключа.',
  ...
  welcomeBody: 'DeepSeek Harness 0.1 пока тестируется разработчиками Harness. Многое ещё требует доработки, и мы будем рады отзывам сообщества разработчиков. Ключевые плагины и базовые API будут быстро развиваться в ближайшие месяцы.\n\nБудем рады вместе с разработчиками всего мира исследовать пределы интеллекта на открытой, многократно используемой и компонуемой инфраструктуре. Приглашаем разработчиков Harness присоединиться к экосистеме плагинов DSH.',
  welcomeContinue: 'Продолжить',
  welcomeError: 'Не удалось сохранить подтверждение. Попробуйте снова.',
  onboardingTitle: 'Добавьте API-ключ для начала',
  onboardingDescription: 'Настройте официального провайдера DeepSeek и начинайте.',
