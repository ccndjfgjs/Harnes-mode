...
export const ru = {
  ...
  'search.unavailable': 'Поиск по содержимому временно недоступен, показаны совпадения в названиях.',
  'search.noMatches': 'Сессии не найдены',
  'search.hasMore': 'Показаны первые {n}. Уточните запрос.',
  'menu.addWorkspace': 'Добавить папку…',
  'picker.loading': 'Загрузка папок…',
  'conflict.named': 'Папка с именем «{name}» уже есть.',
  'folderError.title': 'Не удалось открыть папку',
  'folderError.retry': 'Выбрать снова',
  'rename': 'Переименовать',
  'rename.workspace.title': 'Переименовать папку',
  'rename.session.title': 'Переименовать сессию',
  'field.workspaceName': 'Название папки',
  'field.sessionName': 'Название сессии',
  'delete.workspace': 'Удалить папку',
  'delete.desc': '«{name}» будет убрана из списка. Папка и записи сессий сохранятся, её сессии появятся в «Без группы».',
  'delete.pending': 'Удаление папки…',
  ...
  'actions.workspace.aria': 'Действия папки «{name}»',
  'actions.session.aria': 'Действия сессии «{name}»',
  'actions.newSession.aria': 'Новая сессия в «{name}»',
  'status.running': 'Выполняется',
  'status.subagentsRunning.one': '{n} суб-агент выполняется',
  'status.subagentsRunning.other': 'Суб-агентов выполняется: {n}',
  ...
  'schedule.active': 'Есть активные задачи по расписанию',
