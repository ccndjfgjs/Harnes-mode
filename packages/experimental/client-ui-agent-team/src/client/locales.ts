...
export const ru = {
  ...
  close: 'Закрыть',
  loading: 'Загрузка Team…',
  empty: 'Общих задач пока нет',
  roster: 'Участники',
  tasks: 'Общие задачи',
  model: 'Модель',
  open: 'Открыть сессию teammate',
  create: 'Новая задача',
  ...
  conflict: 'Состояние задачи изменилось, перезагружено. Проверьте и попробуйте снова.',
  'memberStatus.running': 'Выполняется',
  'memberStatus.idle': 'Ожидание',
  'memberStatus.inactive': 'Не выполняется',
